...
class Toolbar extends Component {
   ...
   */
  render() {
    const hasRoles = this.props.userRoles?.length > 0;
    ...
    const folderContentsAction =
      hasRoles &&
      find(this.props.actions.object, {
        id: 'folderContents',
      });
    ...
    return (
      this.props.token && (
        <>
          ...
          />
          <BodyClass className={hasRoles ? 'roles' : 'no-roles'} />
          <div
          ...
          >
            <div className="toolbar-body">
              ...
              <div className="toolbar-bottom">
                ...
                />
                <PersonalInfo toggleMenu={this.toggleMenu} />
              </div>
            </div>
